variable "datadog_endpoints" {
  type        = "list"
  description = "The Datadog HTTP Endpoints to be monitored."
}
variable "datadog_recipients" {
  type = "list"
  description = "List of Datadog @notification recipients to alert when monitor is triggered"
}
